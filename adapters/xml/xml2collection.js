...
module.exports = exports = function() {
	...
	transform : function(req, res, next, db, mongo, config, event) {
		...
		saxStream.on("end", function(comment) {
		    ...
		    if (jsonAttachments[0][0]) // only support 1 attachments
						// section for now
			 ...
			 * up. TODO: Should create mocha tests to verify the
			 * correct file sizes on return TODO: and that the temp
		...
		parserStripBOM._transform = function(data, encoding, done) {
			...
			// could try and edit the Buffer directly instead of
